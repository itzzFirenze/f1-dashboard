               ...
               {hasAnyResults && (
                  <div className="glass-card p-6">
                     ...
                     {activeTab === 'qualifying' && (
                        <div className="flex items-center justify-end gap-6 px-3 pb-2 text-xs font-semibold text-f1-silver/70 uppercase tracking-wider">
                           ...
                           <div key={result.id} className="flex items-center justify-between p-3 rounded-xl hover:bg-f1-mid-gray/30 transition-colors">
                              ...
                              {activeTab === 'qualifying' ? (
                                 <div className="flex items-center gap-6 font-mono text-sm">
                                    <span className="w-16 text-center text-f1-silver">{result.q1 || '—'}</span>
                                    <span className="w-16 text-center text-f1-silver">{result.q2 || '—'}</span>
