          ...
          <div className="flex bg-white/[0.02] border border-white/5 p-1 rounded-xl gap-1 mb-4">
            <button
              ...
              className={`flex-1 py-2 rounded-lg text-xs font-bold transition-all flex justify-center items-center gap-1.5 ${
                activeTab === 'standings' ? 'bg-f1-red text-white' : 'text-f1-silver hover:text-f1-white'
              }`}
            >
            ...
            <button
              ...
              className={`flex-1 py-2 rounded-lg text-xs font-bold transition-all flex justify-center items-center gap-1.5 ${
                activeTab === 'feeds' ? 'bg-f1-red text-white' : 'text-f1-silver hover:text-f1-white'
              }`}
            >
            ...
            <button
              ...
              className={`flex-1 py-2 rounded-lg text-xs font-bold transition-all flex justify-center items-center gap-1.5 ${
                activeTab === 'radio' ? 'bg-f1-red text-white' : 'text-f1-silver hover:text-f1-white'
              }`}
            >
