            ...
            >
               ...
               <div className="relative flex items-end justify-between h-full px-6 pt-1 pb-0">
                  ...
                  <img
                     ...
                     className="h-40 sm:h-56 object-contain object-right-bottom relative z-10 drop-shadow-2xl select-none"
                     ...
                     <Link key={driver.id} to={`/drivers/${driver.id}`}>
                        <div className="glass-card overflow-hidden group cursor-pointer hover:border-white/10">
                           ...
                           >
                              ...
                              />
                              {driverImgUrl && (
                                 <div className="absolute right-0 bottom-0 h-28 w-24 overflow-hidden">
                                    <img
                                       src={driverImgUrl}
                                       alt={`${driver.firstName} ${driver.lastName}`}
                                       className="absolute top-0 left-0 w-full object-cover object-top drop-shadow-xl select-none"
                                       style={{
                                          height: '200%', // crop bottom 50%, show only top half
                                          transform: 'scale(1.25)', // zoom into that top-half crop
