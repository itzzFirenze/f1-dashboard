...
public class RaceResult {
   ...
   /** Qualifying 1 time, e.g. "1:19.507" (qualifying sessions only) */
   @Column(name = "q1_time")
   private String q1Time;
   /** Qualifying 2 time, e.g. "1:18.934" (qualifying sessions only) */
   @Column(name = "q2_time")
   private String q2Time;
   /** Qualifying 3 time, e.g. "1:18.518" (qualifying sessions only) */
   @Column(name = "q3_time")
