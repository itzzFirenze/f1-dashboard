...
public class MomentumDto {
   ...
   public static class RaceMomentum {
      ...
      public double getRollingAvgFinish() {
         return rollingAvgFinish;
      }

      public void setRollingAvgFinish(double rollingAvgFinish) {
         this.rollingAvgFinish = rollingAvgFinish;
      }

      public double getRollingAvgPoints() {
         return rollingAvgPoints;
      }

      public void setRollingAvgPoints(double rollingAvgPoints) {
         this.rollingAvgPoints = rollingAvgPoints;
      }
   }
   ...
   public List<RaceMomentum> getRecentRaces() {
      return recentRaces;
   }

   public void setRecentRaces(List<RaceMomentum> recentRaces) {
      this.recentRaces = recentRaces;
   }
